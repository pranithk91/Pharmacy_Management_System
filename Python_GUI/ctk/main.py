...
logitics_img_data = Image.open("Python_GUI\\ctk\logistics_icon.png")
...
shipping_img_data = Image.open("Python_GUI\\ctk\shipping_icon.png")
...
delivered_img_data = Image.open("Python_GUI\\ctk\delivered_icon.png")
