...
app.title('Login - GUI') 
img1=ImageTk.PhotoImage(Image.open("Python_GUI\ctk\logo.png")) 
...
img2=customtkinter.CTkImage( Image.open("Python_GUI\ctk\package_icon.png").resize((20,20), Image.ANTIALIAS)) 
img3=customtkinter.CTkImage( Image.open("Python_GUI\ctk\plus_icon.png").resize((20,20), Image.ANTIALIAS)) 
